   ...
   const deletePost=(postId)=>{
    ...
    <div>
      <div style={{
        ...
        <li><Link to="/addpost">&nbsp; Create Departemnt</Link> </li>,


      </div>
      <h2 className="center">Liste Departemnt:</h2>
      {   
           mypic.map(item=>{
             return (
                  ...
                  <div className="col-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div className="post-neu card" style={{borderRadius: "20px 20px 20px 20px"}}>
                      ...
                      <div className="card-body">
                        ...
                        <small className="text-muted cat">
                         <Link to={'/post/'+item._id}><a href = {'/post/'+item._id} style={{backgroundColor: "#ed6663", color: "whitesmoke", border: "none"}} class="btn-neu btn btn-info"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp; See full Project</a></Link>
