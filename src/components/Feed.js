...
function Feed() {
    ...
    <div>
      <div style={{
        ...
        <br></br><br></br>
       <h1>hortensia</h1>
       <h3>hortensia <i style={{textDecoration: "none", color: "#ED6663"}} class="fa fa-pencil" aria-hidden="true"></i></h3>
       <hr></hr> <h6>Made with <span style={{color: "red"}}>&#10084;</span> by &nbsp;<a style={{textDecoration: "none", color: "rgb(237,102,99)", textShadow: "2px"}} href="https://arghac14.github.io">Bougatfa</a></h6>
      </div>
